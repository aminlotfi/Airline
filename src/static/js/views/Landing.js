...
export default class extends AbstractView {
    ...
    async getHtml() {
        ...
        <main class="mx-auto w-full max-w-[1200px]">
            <section class="card-box p-16 flex flex-col items-start justify-start w-full mt-56">
            ...
            <section class="py-40">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-24">
                    <div class="rounded-full w-full max-w-[270px]">
                        <img class="object-cover rounded-t-20 w-[270px] h-[150px]" src="static/img/box-1.jpg" alt="Box 1">
                        <div class="bg-white dark:bg-[#14151a] rounded-b-20 py-8 px-16">
                            <span class="text-title text-[14px]">اقدامات ایمنی</span>
                        </div>
                    </div>
                    <div class="rounded-full w-full max-w-[270px]">
                        <img class="object-cover rounded-t-20 w-[270px] h-[150px]" src="static/img/box-2.jpg" alt="Box 2">
                        <div class="bg-white dark:bg-[#14151a] rounded-b-20 py-8 px-16">
                            <span class="text-title text-[14px]">سفر خود را برنامه ریزی کنید</span>
                        </div>
                    </div>
                    <div class="rounded-full w-full max-w-[270px]">
                        <img class="object-cover rounded-t-20 w-[270px] h-[150px]" src="static/img/box-3.jpg" alt="Box 3">
                        <div class="bg-white dark:bg-[#14151a] rounded-b-20 py-8 px-16">
                            <span class="text-title text-[14px]">تضمین تغییر بلیت</span>
                        </div>
                    </div>
                    <div class="rounded-full w-full max-w-[270px]">
                        <img class="object-cover rounded-t-20 w-[270px] h-[150px]" src="static/img/box-4.jpg" alt="Box 4">
                        <div class="bg-white dark:bg-[#14151a] rounded-b-20 py-8 px-16">
                            <span class="text-title text-[14px]">ملزومات ورود و سفر</span>
                        </div>
                    </div>
                </div>
            </section>
            <section class="py-40">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-24">
                    <div class="rounded-full w-full max-w-[270px]">
                        <img class="object-cover rounded-t-20 w-[270px] h-[150px]" src="static/img/box-5.jpg" alt="Box 5">
                        <div class="bg-white dark:bg-[#14151a] rounded-b-20 py-8 px-16">
                    ...
                    <div class="rounded-full w-full max-w-[270px]">
                        <img class="object-cover rounded-t-20 w-[270px] h-[150px]" src="static/img/box-6.jpg" alt="Box 5">
                        <div class="bg-white dark:bg-[#14151a] rounded-b-20 py-8 px-16">
                            <div class="flex flex-col items-start justify-start">
                    ...
                    <div class="rounded-full w-full max-w-[270px]">
                        <img class="object-cover rounded-t-20 w-[270px] h-[150px]" src="static/img/box-7.jpg" alt="Box 5">
                        <div class="bg-white dark:bg-[#14151a] rounded-b-20 py-8 px-16">
                            <div class="flex flex-col items-start justify-start">
                    ...
                    <div class="rounded-full w-full max-w-[270px]">
                        <img class="object-cover rounded-t-20 w-[270px] h-[150px]" src="static/img/box-8.jpg" alt="Box 5">
                        <div class="bg-white dark:bg-[#14151a] rounded-b-20 py-8 px-16">
                            <div class="flex flex-col items-start justify-start">
